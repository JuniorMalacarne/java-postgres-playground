...
public class AppBd {
    ...
    private void localizarEstados(Connection connection, String uf) {
        try {
            ...
            //var result = statement.executeQuery("select * from estado where uf = '" + uf + "'"); // passar e concatenar strings como comandos SQL pode resultar na falha grave de segurança chamada SQL Injection
